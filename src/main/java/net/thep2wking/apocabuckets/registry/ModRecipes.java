...
public class ModRecipes {
	public static void registerRecipes() {
		...
		if (ApocaBucketsConfig.DISASTER.TSUNAMI) {
		...
		if (ApocaBucketsConfig.DISASTER.LAVA_TSUNAMI) {
		...
		if (ApocaBucketsConfig.DISASTER.FROZEN) {
		...
		if (ApocaBucketsConfig.DISASTER.TOXIC) {
		...
		if (ApocaBucketsConfig.DISASTER.WHITE_PAINT) {
		...
		if (ApocaBucketsConfig.DISASTER.PURPLE_PAINT) {
		...
		if (ApocaBucketsConfig.DISASTER.VOID) {
		...
		if (ApocaBucketsConfig.DISASTER.FIRE) {
		...
		if (ApocaBucketsConfig.DISASTER.BLACK_HOLE) {
		...
		if (ApocaBucketsConfig.DISASTER.BLOOD_MOON) {
